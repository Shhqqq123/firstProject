...
def main() -> None:
    ...
    normal = _make_group(rng, n_normal, (12, 10, 16, 20, 2.8), "normal")
    benign = _make_group(rng, n_benign, (17, 14, 24, 30, 3.8), "benign")
    malignant = _make_group(rng, n_malignant, (35, 24, 40, 55, 8.2), "malignant")
