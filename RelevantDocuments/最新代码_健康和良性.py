...
result_df.to_excel("RF_评估结果_良性和健康_阈值校准.xlsx", index=False)
...
plt.title("PR曲线（良性=正类）")
plt.legend()
plt.grid(True, linestyle=":", alpha=0.7)
plt.savefig("PR_Curve_良性和健康_阈值校准.png", dpi=300, bbox_inches="tight")
plt.show()
...
print("评估文件已保存: RF_评估结果_良性和健康_阈值校准.xlsx")
